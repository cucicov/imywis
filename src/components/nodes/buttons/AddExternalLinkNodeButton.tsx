...
import {NODE_TYPES, type ExternalLinkNodeData} from '../../../types/nodeTypes.ts';

const AddExternalLinkNodeButton = () => {
    ...
    return (
        ...
        >
            Add External Link Node
        </button>
    );
};

export default AddExternalLinkNodeButton;
